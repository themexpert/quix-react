...
foreach($field['bar-chart'] as $key => $item) {
...
Assets::js('quix-chartjs-inline-' . $id, QUIX_ELEMENTS_PATH . '/chart-bar/script.php', compact(['id', 'renderer', 'field', 'id_rep', 'labels', 'data', 'bgColor', 'borderColor']), ['qx-chartjs']);
